<?php
    ...
    $stmt = $db->prepare('UPDATE porcionado SET codigo_producto = :codigo_producto, nombre_producto = :nombre_producto, linea_producto = :linea_producto, categoria_producto = :categoria_producto, precio = :precio 
