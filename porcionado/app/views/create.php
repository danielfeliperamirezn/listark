<?php
    ...
    $res = $db->query('SELECT * FROM porcionado WHERE linea_producto = "Res"');
    $cerdo = $db->query('SELECT * FROM porcionado WHERE linea_producto = "cerdo"');
    $frias = $db->query('SELECT * FROM porcionado WHERE linea_producto = "carnes frias"');
    $premium = $db->query('SELECT * FROM porcionado WHERE linea_producto = "cortes premium"');
?>
